...
#define SPEED_THRESHOLD_DEMAG              ((uint32_t)5001) /*!< Speed threshold above which the  RUN_DEMAGN_DELAY_MIN is applied */
...
#define PID_SPEED_KP_DEFAULT          450/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define POTENTIOMETER_ADC_SAMPLING_TIME_M1 LL_ADC_SAMPLING_CYCLE(247)
